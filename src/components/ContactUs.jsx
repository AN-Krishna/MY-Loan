    ...
    <>
      <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2  rounded-lg  w-full p-8 px-16 mt-20 gap-8">
          ...
          <div className="order-1 md:order-2 bg-white  flex items-center justify-center">
            <img src={contactus} alt="Contact" className="w-full max-w-96 h-full max-h-96" />
          </div>
      ...
      <Footer footerColor="bg-blue-400 text-blue-700" />
    </>
  );
};
