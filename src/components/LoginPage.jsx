...
const LoginPage = () => {
  return (
    <div>
        ...
        <div className="w-full max-w-7xl mx-auto z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 p-4 py-16 lg:py-20 lg:px-8">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-600 mb-4">
              Instant Personal Loans up to <span className="text-blue-700">₹45,000</span>
            </h1>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg lg:w-full">
            <div className="flex justify-center mb-4">
              ...
              <div className="flex-shrink-0 font-serif text-blue-500 text-center text-lg font-bold py-3 px-3">
                MyLoan
              </div>
            </div>
            ...
            <div className="flex items-center mt-4 space-x-2">
              ...
              <label htmlFor="terms" className="text-sm text-gray-600">
                ...
                <a href="#" className="text-blue-500 underline">T&C</a>, and to receive communication via WhatsApp.
              </label>
            </div>

            <div className="flex items-center justify-center">
              <button className="bg-blue-500 hover:bg-blue-600 text-white font-light hover:font-semibold w-full md:w-64 py-3 mt-4 rounded-lg">
                Send OTP
              </button>
            </div>

            <Link to="/application" className="flex items-center justify-center">
              <button className="bg-blue-500 hover:bg-blue-600 text-white font-light hover:font-bold w-full py-3 mt-8 rounded-lg">
                Apply Now
              </button>
            </Link>
          </div>
      ...
      <Footer footerColor="bg-neutral-800 text-blue-500" />
    </div>
  );
};
